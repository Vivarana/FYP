...
d3.parcoords = function (config) {
    ...
    pc.autoscale = function () { //autoscaling function for yaxis, which will be called automatically
        ...
        ctx.highlight.lineWidth = 2;
        ctx.shadows.strokeStyle = "#dadada";
        ctx.highlight.globalAlpha = 1;
        ctx.highlight.strokeStyle = '#000'
...
// TODO currently assumes chart is brushable, and destroys old brushes
    ...
    //Draw an array of data with custom color and opacity
    pc.custom_highlight = function (data) {
        d3.select(canvas.foreground).classed("faded", true);
        data.forEach(path_highlight);
        //events.highlight.call(this, data);
        return this;
