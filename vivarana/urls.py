...
urlpatterns = patterns('',
    ...
    url(r'^get_state_obj/$', views.get_state_obj, name='get_state_obj'),
    url(r'^zoom_data/$', views.zoom_data, name='zoom_data'),
    ...
    url(r'^rule_data/$', views.get_tree_data, name='rule_data'),
